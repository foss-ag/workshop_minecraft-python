...
random.randint(lower_bound, upper_bound)
	...
	\begin{center}
		\includegraphics[scale=0.25]{src/lava_runner/res/positions.png}
	\end{center}
	Das mit dem Kreuz markierte Feld stellt die Position des vorherigen Blocks dar, das schwarze Feld ist nicht erreichbar, weshalb ein Block verworfen werden soll, falls er zufällig auf diesem Feld platziert werden soll.
\end{itemize}