...
class Player:
    ...
    def check_bigger(self, x, y):
        return getDistance((x, y),(self.x,self.y)) <= self.mass/2
...
def draw_HUD():
    ...
    drawText("3. NOOB",(screen_width-157,20+25*3))
    drawText("4. h4x0r",(screen_width-157,20+25*4))
